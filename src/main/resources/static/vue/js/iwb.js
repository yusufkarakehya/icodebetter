	...
	render(h){
    	...
    	return h('card',{},[
   			   h('el-row',{style:"padding: 5px"},[
   			                  ...
   			                  ,g.crudFlags && g.crudFlags.insert && h('el-button',{class:"float-right",props:{type:'primary',icon:"el-icon-plus", round:!0},on:{click:this.onNewRecord}},'YENİ KAYIT')
...
//	                         this.header && h('hr',{style:'width:100%'}),
	                         ...
	                         !this.viewMode && this.footer!==false && h('div',{class:"modal-footer"+cls2str(this.footerClasses)},
   	                            this.footer===true ? [h('el-button',{props:{type:"primary"},on:{click:this.submit}},'KAYDET'), h('el-button',{props:{type:"info"},on:{click:this.closeModal}},'KAPAT')]: [h(this.footer)]
   	                         )	                              
                       ])
		    	   ]) 
		    ])
