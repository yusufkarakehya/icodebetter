      ...
      h("el-row", { style: "" }, [
        (!0 || g.searchForm) &&
          h(
            "button",
            {
              ...
              class:
                "icb-button icon icon-shape mb-4 icon-shape-primary rounded-circle"
            },
        ...
        g.crudFlags &&
          ...
          h(
            ...
            {
              style:
                "    background: linear-gradient(87deg,#fb6340,#fbb140)!important;border-radius: 35px;padding: 16px 23px;",
              class: "icb-button float-right",
  ...
  render(h) {
    ...
    if (o.query) {
      ...
      return h(
        ...
        {
          class:
            "card-portlet shadow bg-white text-" +
    ...
    if (o.graph) {
      return h(
        "card",
        {
          class:
            "card-portlet shadow " +
            (o.props.color ? "bg-" + o.props.color : "")
        },
        [
          h(
            "h3",
    ...
    render(h) {
      ...
      return h(
        ...
        o.rows.map(rowItem => {
          return h(
            "div",
            { class: "row", style: "padding-bottom: 30px;" },
            rowItem.map(colItem =>
  ...
  render(h) {
    ...
    return h("card", {}, [
      h("row", { style: "" }, [
        h("button", {
          class:
            "el-button icon icon-shape bg-gradient-warning shadow rounded-circle text-white",
