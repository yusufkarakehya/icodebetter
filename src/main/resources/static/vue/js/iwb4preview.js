  ...
  methods: {
    ...
    dblClick(row) {
      ...
      if (g.crudFlags && g.crudFlags.edit && this.showForm) {
        ...
        var url =
          "../app/showForm?_renderer=vue2&a=1&_fid=" +
          this.grid.crudFormId +
          pkz;
...
var XMainPanel = Vue.component("x-main-panel", {
  ...
  mounted() {
    ...
    if (!this.t) {
      var url = "../app/showPage?_tid=" + this.tid,
      ...
      return h(
        ...
        [
          ...
          h("card-block", { class: "pb-0" }, [
            ...
            h(
              "h1",
              { class: "mb-0", style: "font-size:32px;color: gray;" },
              q.dsc
            ),
            h("hr", {
              style:
            ...
            h(
              "div",
              { style: "color: #aaa;font-size: .9rem;margin-top:22px" },
      ...
      return h(
        ...
        [
          h(
            ...
            {
              class: "form-header",
              style: "font-size:1.5rem;padding: 0px 2px 0px;margin-bottom:0px"
            },
            name
          ),
