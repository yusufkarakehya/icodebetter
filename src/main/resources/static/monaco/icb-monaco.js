        ...
        afterrender: function () {	
          ...
          */
          ...
          function resizeEditor() {        	  
        	  if((self.el.dom && self.editor.getDomNode() && self.editor.getDomNode().clientHeight != self.el.dom.clientHeight) ||
        		(self.el.dom && self.editor.getDomNode() && self.editor.getDomNode().clientWidth != self.el.dom.clientWidth )){
        		  self.editor.layout();
