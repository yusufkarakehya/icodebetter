...
//    	r.splice(0,0,_('div',{className:'bg-pic'}));
	...
	ll.unshift(_('li',{className:'nav-item menu-profile-pic',style:{paddingTop:26, textAlign:'center', paddingBottom:20}},[
        _("img", { src: "sf/pic"+_scd.userId+".png", "className": "img-avatar", style:{width:64,border: ".5px solid #cecece"}, alt: _scd.email})
        ,_('div',{style:{fontWeight:'bold', paddingTop:6}},_scd.completeName)
   ])); //_('div',null,'Veli'),

    return _( "div",{ className: "sidebar" },
    		  _("nav",{ className: "sidebar-nav" },_(Nav, null/*,_('div',{className:'bg-pic'})*/, ll))
    );
  }
}
