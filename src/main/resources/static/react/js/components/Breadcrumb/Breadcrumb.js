...
//	  if(routeName=='Home')routeName=_('i',{className:'icon-home'});
	  if(routeName=='Home')routeName=_(Button, {className:'btn-round-shadow', color:'home', style:{marginTop:'-8px'}},_('i',{className:'icon-home'}));
    return (
      match.isExact ?
...
const Breadcrumbs = ({location : {pathname}, match}) => {
  ...
  return _(Breadcrumb, null, _('h3',{id:'id-breed'},'iWorkBetter'),_('span',{style:{width: '20px'}},' '),items);
};

const Breadcrumb2 = (props) =>{
	 return _("div", {className:"d-md-down-none"},  _(Route, Object.assign({ path: "/:path", component: Breadcrumbs }, props)));
}
/*
