...
function disabledCheckBoxHtml(row, cell){
	return row[cell] && 1*row[cell] ? _('i',{className:'fa fa-check', style:{color:'green'}}) : null;// _('i',{className:'fa fa-check', style:{color: 'white',background: 'red', padding: 5, borderRadius: 25}});
}
