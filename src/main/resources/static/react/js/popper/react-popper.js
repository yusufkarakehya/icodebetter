...
var ReactPopper = function(global){
	var PopperJS = global.Popper;
	...
	var Manager = function (_Component) {
	  ...
	  createClass(Manager, [{
	    ...
	    value: function render() {
	      ...
	      if (tag !== false) {
	        return _(tag, restProps, children);
	      } else {
	        return children;
	      }
	    }
	...
	var Target = function Target(props, context) {
	  ...
	  return _(component, componentProps, children);
	};
	...
	return {Manager:Manager, Target:Target, Popper:Popper, placements:placements, Arrow:Arrow}
...
ReactPopper = ReactPopper(window);