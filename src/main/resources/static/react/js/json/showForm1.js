...
}, _(Card, null, _(CardHeader, null, 
		_('strong', null, 'Credit Card'), _('small', null, ' Form')
		), _(CardBlock, {
    className: 'card-body'
...
, _('hr'),_('div',{className:'form-actions'},_(Button,{type:'submit',color:'primary'},'Save Changes'),' ',_(Button,{color:'secondary'},'Cancel'))
))));
