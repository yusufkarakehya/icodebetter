...
Ext.ux.form.CodeMirror = Ext.extend(Ext.form.TextArea, {
     ...
     */
    codeMirrorPath: '../scripts/ext3.3/codemirror',
    ...
    initComponent: function () {
        ...
        this.on({
            ...
            afterrender: function () {
                ...
                if((self.modeJs || self.mode)!='javascript')self.codeEditor.setOption("lint", false);
                (function(){
                    self.codeEditor.setOption("mode", self.modeJs || self.mode);
