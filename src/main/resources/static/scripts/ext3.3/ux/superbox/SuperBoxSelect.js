...
Ext.ux.form.SuperBoxSelect = function(config) {
    ...
    this.addEvents(
        ...
        'autoSize',
        /**
         * Fires when addItemBox is called
         * @event clear
         * @memberOf Ext.ux.form.SuperBoxSelect
         * @param {SuperBoxSelect} this
         * @param {SuperBoxSelectItem} the added box
         */
        'addItemBox'
    );
...
Ext.ux.form.SuperBoxSelect = Ext.extend(Ext.ux.form.SuperBoxSelect,Ext.form.ComboBox,{
    ...
    initComponent:function() {       
       Ext.apply(this, {
        ...
        if(/*this.mode === 'remote' &&*/ this.store){// danh200 = if(this.mode === 'remote' && this.store) ... bizdeki  if(/*this.mode === 'remote' &&*/ this.store)
    ...
    onStoreLoad : function(store, records, options){
    	...
    	/*var q = Ext.apply({}, options.params, this.baseParams),
    		isValuesQuery =Ext.apply( options.params[this.queryValuesIndicator] , store.baseParams[this.queryValuesIndicator]);*/
    ...
    restrictHeight : function(){
        ...
        this.ownerCt.doLayout();// çok iyi oldu çok da tam süper oldu.
    },
    ...
    /* Ext Forum da sevgili Animal aşağıdaki gibi yapmış. 
      onEnable: function() {
    ...
    onKeyUp : function(e) {
    	if (this.readOnly != true && this.editable !== false && (!e.isSpecialKey() || e.getKey() === e.BACKSPACE) && this.itemDelimiterKey.indexOf(e.getKey()) === -1 && (!e.hasModifier() || e.shiftKey)) {
    ...
    addItemBox : function(itemVal,itemDisplay,itemCaption, itemClass, itemStyle) {
        ...
        this.fireEvent('addItemBox', this, box);
    },
