...
//		alert('onRealBlur 3 ' + rv)
		var rva = rv.split(new RegExp(RegExp.escape(this.separator) + ' *'));
//		alert('onRealBlur 3b ' + rva)
		var va = [];
		var snapshot = this.store.snapshot || this.store.data;
		...
		Ext.each(rva, function(v) {
			snapshot.each(function(r) {
//				alert('each[' + v + ' == ' + r.get(this.displayField) + '] = ' + (v == r.get(this.displayField)))
...
//		alert('onRealBlur 4a ' + va)
//		alert('onRealBlur 4v ' + this.getValue())
		this.store.clearFilter();
...
//				alert('before this.valueField :' +v + ' / ' + this.getCheckedValue())
				this.store.clearFilter();
				this.bahar = this.getCheckedValue();
				this.store.each(function(r) {
					var checked = !(!v.match(
...
//				alert('after this.valueField :' +v + ' / ' + this.getCheckedValue())
				
				this.value = this.getCheckedValue();
				if(!this.value)this.value=this.bahar
...
//    ,getValue:function(a,b,c){alert('getValue '+this.value);return this.value}
});
// register xtype
