!(function(t) {
  ...
  function e(t, e) {
    var l = t.querySelectorAll("*[data-intro]"),
      a = [];
    ...
    for (var u = [], d = 0; d < a.length; d++) a[d] && u.push(a[d]);
    return (
      (a = u).sort(function(t, e) {
      ...
      function(t) {
        ...
        return (
          t.appendChild(e),
          (e.onclick = function() {
            !0 === n._options.exitOnOverlayClick && r.call(n, t);
          }),
        ...
        this._options.keyboardNavigation &&
          _.on(window, "keydown", n, this, !0),
        _.on(window, "resize", i, this, !0)),
      !1
    );
  }
  function i() {
  ...
  function n(t) {
    ...
    if (
      ...
      else if ("ArrowRight" === e || 39 === e) s.call(this);
    ...
    } else r.call(this, this._targetElement);
  }
  function o(t) {
    ...
    return (
      ...
      !1 === e
        ...
        : this._introItems.length <= this._currentStep
          ? ("function" == typeof this._introCompleteCallback &&
              this._introCompleteCallback.call(this),
            void r.call(this, this._targetElement))
          : void f.call(this, t)
    );
  }
  function l() {
  ...
  function r(t, e) {
    ...
    if (
      ...
      c && c.parentNode.removeChild(c),
        b(),
        g(document.querySelectorAll(".introjs-fixParent"), function(t) {
          C(t, /introjs-fixParent/g);
        }),
        _.off(window, "keydown", n, this, !0),
        _.off(window, "resize", i, this, !0),
  ...
  function a(t, e, i, n, o) {
    ...
    if (
      ...
      switch (
        ...
        (e.className = ("introjs-tooltip " + p).replace(/^\s+|\s+$/g, "")),
        e.setAttribute("role", "dialog"),
        "floating" !== (d = this._introItems[this._currentStep].position) &&
          (d = function(t, e, i) {
            var n = this._options.positionPrecedence.slice(),
              ...
              a = "floating";
            r.bottom + s + s > o.height && u(n, "bottom");
            r.top - s < 0 && u(n, "top");
            r.right + l > o.width && u(n, "right");
            r.left - l < 0 && u(n, "left");
            var c = ((h = i || ""),
            (d = h.indexOf("-")),
            -1 !== d ? h.substr(d) : "");
            var h, d;
            i && (i = i.split("-")[0]);
            n.length && (a = "auto" !== i && n.indexOf(i) > -1 ? i : n[0]);
            -1 !== ["top", "bottom"].indexOf(a) &&
              (a += (function(t, e, i, n) {
                var o = e / 2,
                  ...
                  r = "";
                s - t < e && u(l, "-left-aligned");
                (t < o || s - t < o) && u(l, "-middle-aligned");
                t < e && u(l, "-right-aligned");
                r = l.length
                  ? -1 !== l.indexOf(n)
                    ? n
                    : l[0]
        ...
        case "top-right-aligned":
          ...
          var f = 0;
          h(r, f, l, e), (e.style.bottom = r.height + 20 + "px");
          break;
        case "top-middle-aligned":
          i.className = "introjs-arrow bottom-middle";
          var m = r.width / 2 - l.width / 2;
          o && (m += 5),
            h(r, m, l, e) && ((e.style.right = null), c(r, m, l, a, e)),
  ...
  function d(t) {
    if (t) {
      ...
      x(e.element)
        ? w(t, "introjs-fixedTooltip")
        : C(t, "introjs-fixedTooltip"),
  ...
  function f(t) {
    ...
    var e,
      ...
      o,
      c = this,
      h = document.querySelector(".introjs-helperLayer"),
      u = document.querySelector(".introjs-tooltipReferenceLayer"),
      f = "introjs-helperLayer";
    if (
      ("string" == typeof t.highlightClass && (f += " " + t.highlightClass),
      "string" == typeof this._options.highlightClass &&
        (f += " " + this._options.highlightClass),
      null !== h)
    ) {
      var y = u.querySelector(".introjs-helperNumberLayer"),
        v = u.querySelector(".introjs-tooltiptext"),
        _ = u.querySelector(".introjs-arrow"),
        x = u.querySelector(".introjs-tooltip");
      if (
        ((n = u.querySelector(".introjs-skipbutton")),
        (i = u.querySelector(".introjs-prevbutton")),
        (e = u.querySelector(".introjs-nextbutton")),
        (h.className = f),
        (x.style.opacity = 0),
        (x.style.display = "none"),
        null !== y)
      ) {
        var k = this._introItems[t.step - 2 >= 0 ? t.step - 2 : 0];
        ((null !== k &&
      ...
      (o = H(t.element)) !== document.body && O(o, t.element),
        d.call(c, h),
        d.call(c, u),
        g(document.querySelectorAll(".introjs-fixParent"), function(t) {
          C(t, /introjs-fixParent/g);
        ...
        b(),
        c._lastShowElementTimer && window.clearTimeout(c._lastShowElementTimer),
        (c._lastShowElementTimer = window.setTimeout(function() {
          null !== y && (y.innerHTML = t.step),
            (v.innerHTML = t.intro),
            (x.style.display = "block"),
            a.call(c, t.element, x, _, y),
            c._options.showBullets &&
              ((u.querySelector(".introjs-bullets li > a.active").className =
                ""),
              (u.querySelector(
      ...
      (S.className = f),
        ...
        d.call(c, S),
        d.call(c, E),
        this._targetElement.appendChild(S),
        this._targetElement.appendChild(E),
        (N.className = "introjs-arrow"),
        (L.className = "introjs-tooltiptext"),
        (L.innerHTML = t.intro),
        (T.className = "introjs-bullets"),
        !1 === this._options.showBullets && (T.style.display = "none");
      var q = document.createElement("ul");
      q.setAttribute("role", "tablist");
      var B = function() {
        c.goToStep(this.getAttribute("data-stepnumber"));
      };
      g(this._introItems, function(e, i) {
        var n = document.createElement("li"),
          o = document.createElement("a");
        n.setAttribute("role", "presentation"),
          o.setAttribute("role", "tab"),
          (o.onclick = B),
          i === t.step - 1 && (o.className = "active"),
          p(o),
          (o.innerHTML = "&nbsp;"),
      ...
      (R.className = "introjs-progressbar"),
        R.setAttribute("role", "progress"),
        R.setAttribute("aria-valuemin", 0),
        R.setAttribute("aria-valuemax", 100),
        R.setAttribute("aria-valuenow", M.call(this)),
        (R.style.cssText = "width:" + M.call(this) + "%;"),
        I.appendChild(R),
        (P.className = "introjs-tooltipbuttons"),
        !1 === this._options.showButtons && (P.style.display = "none"),
      ...
      !0 === this._options.showStepNumbers &&
        ...
        ((i = document.createElement("a")).onclick = function() {
          0 !== c._currentStep && l.call(c);
        }),
        p(i),
        (i.innerHTML = this._options.prevLabel),
        ((n = document.createElement("a")).className =
          this._options.buttonClass + " introjs-skipbutton "),
        p(n),
        (n.innerHTML = this._options.skipLabel),
        (n.onclick = function() {
          c._introItems.length - 1 === c._currentStep &&
            "function" == typeof c._introCompleteCallback &&
            c._introCompleteCallback.call(c),
            c._introItems.length - 1 !== c._currentStep &&
              "function" == typeof c._introExitCallback &&
              c._introExitCallback.call(c),
            c._introSkipCallback.call(c),
            r.call(c, c._targetElement);
        }),
        P.appendChild(n),
        this._introItems.length > 1 && (P.appendChild(i), P.appendChild(e)),
        A.appendChild(P),
        a.call(c, t.element, A, N, V),
        m.call(this, t.scrollTo, t, A);
    }
    var z = c._targetElement.querySelector(".introjs-disableInteraction");
    z && z.parentNode.removeChild(z),
      ...
      0 === this._currentStep && this._introItems.length > 1
        ? (null != n &&
            (n.className = this._options.buttonClass + " introjs-skipbutton"),
          null != e &&
            (e.className = this._options.buttonClass + " introjs-nextbutton"),
          !0 === this._options.hidePrev
            ? (null != i &&
                (i.className =
                  this._options.buttonClass +
                  " introjs-prevbutton introjs-hidden"),
              null != e && w(e, "introjs-fullbutton"))
            : null != i &&
              (i.className =
                this._options.buttonClass +
                " introjs-prevbutton introjs-disabled"),
          null != n && (n.innerHTML = this._options.skipLabel))
        : this._introItems.length - 1 === this._currentStep ||
          1 === this._introItems.length
          ? (null != n &&
              ((n.innerHTML = this._options.doneLabel),
              w(n, "introjs-donebutton")),
            null != i &&
              (i.className = this._options.buttonClass + " introjs-prevbutton"),
            !0 === this._options.hideNext
              ? (null != e &&
                  (e.className =
                    this._options.buttonClass +
                    " introjs-nextbutton introjs-hidden"),
                null != i && w(i, "introjs-fullbutton"))
              : null != e &&
                (e.className =
                  this._options.buttonClass +
        ...
        if (t.element instanceof SVGElement)
          for (
            ...
            "svg" === e.tagName.toLowerCase() &&
              w(e, "introjs-showElement introjs-relativePosition"),
              (e = e.parentNode);
        w(t.element, "introjs-showElement");
        var i = j(t.element, "position");
        "absolute" !== i &&
          "relative" !== i &&
          "fixed" !== i &&
          w(t.element, "introjs-relativePosition");
        e = t.element.parentNode;
        for (
          ;
          ...
          var n = j(e, "z-index"),
            o = parseFloat(j(e, "opacity")),
            s =
              j(e, "transform") ||
              j(e, "-webkit-transform") ||
              j(e, "-moz-transform") ||
              j(e, "-ms-transform") ||
              j(e, "-o-transform");
          (/[0-9]+/.test(n) || o < 1 || ("none" !== s && void 0 !== s)) &&
            w(e, "introjs-fixParent"),
            (e = e.parentNode);
        }
      })(t),
  ...
  function m(t, e, i) {
    ...
    if (
      ...
      (this._options.scrollToElement &&
        ...
        (o = e.element),
        !(
          (s = o.getBoundingClientRect()).top >= 0 &&
          s.left >= 0 &&
  ...
  function b() {
    g(document.querySelectorAll(".introjs-showElement"), function(t) {
      C(t, /introjs-[a-zA-Z]+/g);
    });
  }
  function g(t, e, i) {
  ...
  var y,
    ...
    _ = new function() {
      ...
      (this._id = function(t, e, i, n) {
        return e + v(i) + (n ? "_" + v(n) : "");
      }),
        (this.on = function(e, i, n, o, s) {
          ...
          "addEventListener" in e
            ...
            : "attachEvent" in e && e.attachEvent("on" + i, r),
            (e[t] = e[t] || {}),
            (e[t][l] = r);
        }),
        (this.off = function(e, i, n, o, s) {
          var l = this._id.apply(this, arguments),
            r = e[t] && e[t][l];
          "removeEventListener" in e
            ? e.removeEventListener(i, r, s)
            : "detachEvent" in e && e.detachEvent("on" + i, r),
            (e[t][l] = null);
        });
    }();
  function w(t, e) {
  ...
  function x(t) {
    var e = t.parentNode;
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === j(t, "position") || x(e))
    );
  }
  function k() {
  ...
  function E(t) {
        ...
        function(t) {
          ...
          (e = e ? "true" === e : this._options.hintAnimation),
            this._introItems.push({
              ...
              tooltipClass: t.getAttribute("data-tooltipclass"),
              position:
                t.getAttribute("data-position") || this._options.tooltipPosition
            });
        }.bind(this)
      );
    }
    (function() {
        ...
        function(i, n) {
          if (!document.querySelector('.introjs-hint[data-step="' + n + '"]')) {
            ...
            p(s),
              ...
              (s.className = "introjs-hint"),
              i.hintAnimation || w(s, "introjs-hint-no-anim"),
              x(i.element) && w(s, "introjs-fixedhint");
            var l = document.createElement("div");
            l.className = "introjs-hint-dot";
            var r = document.createElement("div");
            (r.className = "introjs-hint-pulse"),
              s.appendChild(l),
              s.appendChild(r),
              s.setAttribute("data-step", n),
              (i.targetElement = i.element),
              (i.element = s),
              P.call(this, i.hintPosition, s, i.targetElement),
              e.appendChild(s);
          }
        }.bind(this)
      ),
      ...
      _.on(document, "click", S, this, !1),
      _.on(window, "resize", N, this, !0));
  }
  function N() {
    g(
      this._introItems,
      function(t) {
        void 0 !== t.targetElement &&
          P.call(this, t.hintPosition, t.element, t.targetElement);
      }.bind(this)
    );
  }
  function A(t) {
  ...
  function q(t) {
    ...
    if (parseInt(n, 10) !== t) {
      ...
      (h.className = this._options.buttonClass),
        h.setAttribute("role", "button"),
        (h.innerHTML = this._options.hintButtonLabel),
        (h.onclick = L.bind(this, t)),
        s.appendChild(c),
        s.appendChild(h),
  ...
  var R = function(e) {
    var i;
    if ("object" == typeof e) i = new t(e);
    else if ("string" == typeof e) {
      var n = document.querySelector(e);
      if (!n) throw new Error("There is no element with given selector.");
      i = new t(n);
    } else i = new t(document.body);
    return (R.instances[v(i, "introjs-instance")] = i), i;
  };
  return (
    (R.version = "2.9.0"),
    (R.instances = {}),
    (R.fn = t.prototype = {
        ...
        return (
          function(t) {
            (this._currentStep = t - 2),
              void 0 !== this._introItems && s.call(this);
          }.call(this, t),
          this
        );
      },
      ...
      exit: function(t) {
        return r.call(this, this._targetElement, t), this;
      },
      refresh: function() {
        return (
          function() {
      ...
      addHints: function() {
        return E.call(this, this._targetElement), this;
      },
      hideHint: function(t) {
        ...
        return (
          function() {
            g(
              A(".introjs-hint"),
              function(t) {
                L.call(this, t.getAttribute("data-step"));
              }.bind(this)
            );
          }.call(this),
          this
          ...
          function() {
            ...
            t && t.length
              ? g(
                  t,
                  function(t) {
                    T.call(this, t.getAttribute("data-step"));
                  }.bind(this)
                )
        ...
        return (
          function() {
            g(
              A(".introjs-hint"),
              function(t) {
                I.call(this, t.getAttribute("data-step"));
              }.bind(this)
            );
          }.call(this),
          this
