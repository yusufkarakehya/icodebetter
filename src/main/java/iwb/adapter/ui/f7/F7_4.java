...
//								break;
	...
	public	StringBuilder	serializeList(M5ListResult	listResult){
		if(true)return serializeListMaterial(listResult);
	...
	private	StringBuilder	serializeListMaterial(M5ListResult	listResult){
		...
		if(GenericUtil.isEmpty(l.getHtmlPageCode())){
			...
			.append("\n<div class=\"navbar\"><div class=\"navbar-inner\"><div class=\"left\"><a href=\"#\" class=\"link icon-only panel-open\" data-panel=\"left\"><i class=\"icon f7-icons if-not-md\">menu</i><i class=\"icon material-icons if-md\">menu</i></a></div>")
...
//			if(l.getHideBarsOnScrollFlag()!=0)s2.append(" hide-bars-on-scroll");
			...
			s2.append("<div class=\"list").append(searchBar ? " searchbar-found":"").append("\"><ul id=\"idx-").append(l.getListId()).append("\">");
