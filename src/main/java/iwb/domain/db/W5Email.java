 ...
 */
@Entity
@Table(name="w5_email",schema="PROMIS_EXT")
public class W5Email implements java.io.Serializable {

	private int mailId;
	private int mailSettingId;
	private int mailFolderId;
	...
	private String mailKeepBodyOriginal; // bu body part kısmında \n <br> ile replace olacak mı ?
	...
	public int getMailFolderId() {
		return mailFolderId;
	}


	public void setMailFolderId(int mailFolderId) {
	...
	public W5Email(String mailTo, String mailCc, String mailBcc,
			String mailSubject,String mailBody, String mailKeepBodyOriginal, List<W5FileAttachment> fileAttachments) {
		super();
		this.mailTo = mailTo;
		this.mailCc = mailCc;
		this.mailBcc = mailBcc;
	...
	@Transient
	public String getMailKeepBodyOriginal() {
		return mailKeepBodyOriginal;
	}
