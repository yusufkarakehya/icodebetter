...
public class GenericUtil {
  ...
  public static String uDateStr(String e) {
    ...
    if (cal.get(Calendar.DAY_OF_MONTH) < 10) curDay = "0" + curDay;
    String curMonth = new Integer(cal.get(Calendar.MONTH) + 1).toString();
    if (cal.get(Calendar.MONTH) < 9) curMonth = "0" + curMonth;
  ...
  public static Integer uIntegerNullIfZero(String x) {
    ...
    try {
      ...
      if (i != null && i.intValue() == 0) return null;
      else return i;
    } catch (Exception e) {
      return null;
    }
  ...
  public static Short uShortNullIfZero(String x) {
    ...
    try {
      ...
      if (s != null && s.shortValue() == 0) return null;
      else return s;
    } catch (Exception e) {
      return null;
    }
  ...
  public static Short uShortZeroIfNull(String x) {
    ...
    try {
      Short s = Short.valueOf(x);
      if (s == null) return new Short((short) 0);
      else return s;
    } catch (Exception e) {
  ...
  public static void replaceCharWidthString(
      StringBuilder source, StringBuilder destination, char c, String s) {
    int n = source.length();
    for (int j = 0; j < n; j++) {
      char x = source.charAt(j);
      if (x == c) destination.append(s);
      else destination.append(x);
    }
  }

  public static void replaceCharWidthString(
      String source, StringBuilder destination, char c, String s) {
    int n = source.length();
    for (int j = 0; j < n; j++) {
      char x = source.charAt(j);
      if (x == c) destination.append(s);
  ...
  public static String stringToJS(String source) {
    ...
    for (int j = 0; j < n; j++) {
      ...
      switch (x) {
        case '/':
          if (j < n - 1 && source.charAt(j + 1) == '/') sb.append("\\/");
          else sb.append("/");
          break;
    ...
    for (int j = 0; j < n; j++) {
      ...
      switch (x) {
        case '/':
          ...
          break;
          //			case '/':if(j<n-1 && source.charAt(j+1)=='/')sb.append("/'+'");else
          // sb.append("/");break;
        case '\\':
          sb.append("\\\\");
          break;
    ...
    for (Object q : s.keySet()) {
      ...
      if (o != null && (o instanceof Integer || o instanceof Double || o instanceof BigDecimal))
        ...
        html.append("\"")
            .append(q)
            .append("\":\"")
            .append(o != null ? stringToJS2(o.toString()) : "")
            .append("\"");
    }
    html.append("}");
    ...
    for (Object q : s.keySet()) {
      ...
      if (o != null
          && (o instanceof Integer
              ...
              || o instanceof Boolean)) html.append("\"").append(q).append("\":").append(o);
      else
        html.append("\"")
            .append(q)
            .append("\":\"")
    ...
    for (Object q : s.keySet()) {
      ...
      if (o != null
          && (o instanceof Integer
              || o instanceof Double
              || o instanceof BigDecimal
              || o instanceof Boolean)) html.append(q).append("=").append(o);
      else
        html.append(q)
            .append("=\"")
            .append(o != null ? stringToJS2(o.toString()) : "")
  ...
  public static String fromListToJsonString2Recursive(List<Object> s) {
    ...
    for (Object o : s) {
      ...
      } else html.append("\"").append(stringToJS2(o.toString())).append("\"");
    }
    html.append("]");
    return html.toString();
  }
  ...
  public static String fromMapToJsonString2Recursive(Map<String, Object> s) {
    ...
    for (Object q : s.keySet()) {
      ...
      Object o = s.get(q);
      if (o == null) html.append("\"").append(q).append("\":\"\"");
        ...
        html.append("\"")
            .append(q)
            .append("\":")
            .append(fromListToJsonString2Recursive((List<Object>) o));
      } else if (o instanceof Integer
          || o instanceof Double
          || o instanceof BigDecimal
          ...
          || o instanceof Short
          || o instanceof Long
          || o instanceof Float) html.append("\"").append(q).append("\":").append(o);
      else if (o instanceof NativeObject)
        html.append("\"")
            .append(q)
            .append("\":")
  ...
  public static boolean uBoolean(String x) {
    if (x == null || x.trim().length() == 0) return false;
    try {
  ...
  */
  ...
  public static <T> T getFirstItem(List<T> find) {
    if (find == null || find.size() == 0) return null;
    return find.get(0);
  }
  ...
  public static <T> T stringToType(String value, Class<T> type, T defaultValue) {
    try {
      ...
      else if (type.isAssignableFrom(String.class)) return (T) value;
      else if (type.isAssignableFrom(Integer.class) || type.isAssignableFrom(int.class))
        return (T) new Integer(value);
      else if (type.isAssignableFrom(Double.class) || type.isAssignableFrom(double.class))
        return (T) new Double(value);
      else if (type.isAssignableFrom(BigDecimal.class)) return (T) new BigDecimal(value);
      else if (type.isAssignableFrom(Long.class)) return (T) new Long(value);
      else throw new RuntimeException("Bilinmeyen veri tipi " + type + " (property=" + value + ")");
  ...
  public static <T> T stringToType(String value, Class<T> type) {
    if (type.isAssignableFrom(Boolean.class) || type.isAssignableFrom(boolean.class))
      return (T)
          (Boolean) ("true".equalsIgnoreCase(value) || "1".equals(value) || "on".equals(value));
    if (type.isAssignableFrom(String.class)) return (T) value;
    ...
    if (type.isAssignableFrom(Double.class) || type.isAssignableFrom(double.class))
      return (T) new Double(value);
    if (type.isAssignableFrom(BigDecimal.class)) return (T) new BigDecimal(value);
    ...
    if (Enum.class.isAssignableFrom(type)) {
      ...
      Object res = null;
      for (int i = 0; i < e.length; i++) if (e[i].toString().equals(value)) res = e[i];
      return (T) res;
    }
    if (type.isAssignableFrom(Integer[].class)) {
      String[] s = value.trim().split(",");
      Integer[] ia = new Integer[s.length];
      for (int i = 0; i < ia.length; i++) ia[i] = uInt(s[i]);
      return (T) ia;
    }
  ...
  public static String obj2Str_AlignLengthChar(
      Object o, int a, int l, char c) { // a:0center,1left,2right
  ...
  public static Map<String, String> getParameterMap(HttpServletRequest request) throws IOException {
    ...
    for (Map.Entry<String, String[]> e : m.entrySet()) {
      ...
      String resx = "";
      for (String s : (String[]) e.getValue()) resx += "," + s;
  ...
  public static Object prepareParam(
      W5Param param,
        ...
        try {
          ...
          if (scope.has("errorMsg", scope)) {
            ...
            if (em != null) {
              errorMap.put(
                  param.getDsc(),
                  LocaleMsgCache.get2(0, (String) scd.get("locale"), em.toString()));
            }
          }
  ...
  public static boolean accessControl(
      Map<String, Object> scd, short accessTip, String accessRoles, String accessUsers) {
    boolean b =
        (accessTip == 0)
            || (hasPartInside2(accessRoles, scd.get("roleId"))
                || hasPartInside2(accessUsers, scd.get("userId")));
    return b;
  }

  public static int accessControlFormCell(
      Map<String, Object> scd,
      short accessTip,
      String accessRoles,
    ...
    for (int i = 0; i < sql.length(); i++)
      if (sql.charAt(i) == '?') {
        ...
        if (o == null) b.append("null");
          ...
          b.append("to_date('")
              .append(uFormatDateTime((java.sql.Timestamp) o))
              .append("','")
              .append(dateFormat.concat(" HH:mm:ss"))
              .append("')");
        else if (o instanceof java.sql.Date)
          b.append("to_date('")
              .append(uFormatDate((java.sql.Date) o))
              .append("','")
              .append(dateFormat)
              .append("')");
        else if (o instanceof java.util.Date)
          b.append("to_date('")
              .append(uFormatDate((java.util.Date) o))
              .append("','")
              .append(dateFormat)
              .append("')");
        else b.append(o);
  ...
  public static StringBuilder filterExt(
      String code,
      Map<String, Object> scd,
      Map<String, String> requestParams,
    ...
    for (int bas = tmp.indexOf("${"); bas > 0; bas = tmp.indexOf("${", bas + 2)) {
      ...
      if (subStr.startsWith("scd.")) {
        replaced =
            scd != null && scd.get(subStr.substring(4)) != null
                ? scd.get(subStr.substring(4)).toString()
                : "null"; // getMsgHTML de olabilirdi
      } else if (subStr.startsWith("req.")) {
        replaced =
            requestParams != null && requestParams.get(subStr.substring(4)) != null
                ? requestParams.get(subStr.substring(4))
                : "null"; // getMsgHTML de olabilirdi
      } else if (subStr.startsWith("obj.")) {
        replaced =
            obj != null && obj.get(subStr.substring(4)) != null
                ? obj.get(subStr.substring(4)).toString()
                : "null"; // getMsgHTML de olabilirdi
      } else if (subStr.startsWith("app.")) {
        replaced =
            FrameworkCache.getAppSettingStringValue(
                scd.get("customizationId"), subStr.substring(4));
      } else {
        replaced =
            LocaleMsgCache.get2(
  ...
  public static ArrayList<Object[]> transposeList(
      ArrayList<Object[]> data) { // ArrayList satï¿½r-sutun yer degistiriyor.
  ...
  public static W5FormCellHelper getFormCellResultByQueryRecord(Object[] d) {
    ...
    if (d.length > 11)
      cell.setTabOrder(
          (short) GenericUtil.uInt(d[11])); // istenirse alindiktan sonra override edilebilir
  ...
  public static boolean moveFile(String fileName, String directoryName) {
    ...
    try { // copy then delete,
      ...
      if (!success)
        System.out.println(
            "File is failed to move!,fileName: "
                + fileName
                + ",newFile : "
                + directoryName
                + "\\"
  ...
  public static String completeChar(
      String deger, String karakter, short count, boolean alignRight) {
    String res = deger;
    for (int i = 0; i < (count - deger.length()); i++) {
      if (alignRight) res = karakter + res;
      else res += karakter;
    }
    return res;
  }
  ...
  public static String report2csv(List<W5ReportCellHelper> reportList) {
    ...
    for (W5ReportCellHelper sonuc : reportList) {
      if ((sonuc.getRowTip() == 2)
          || (sonuc.getRowTip() == 3)) { // kolon baï¿½lï¿½ï¿½ï¿½ yada deï¿½erler ise
        if (sonuc.getColumnId() == 1) {
          if (ilk == false)
            sb.append(
                new Character((char) 13).toString()
                    + new Character((char) 10).toString()); // satï¿½r sonu
          else ilk = false;
        }
        String deger = "";
        if (sonuc.getDeger() != null) deger = sonuc.getDeger();
        sb.append(deger);
  ...
  public static String report2text(List<W5ReportCellHelper> reportList) {
    ...
    for (W5ReportCellHelper sonuc : reportList) {
      ...
      if ((sonuc.getRowTip() == 0)) { // baï¿½lï¿½k
        ...
        String sp = " ";
        if ((sonuc.getTag() != null) && (sonuc.getTag() != "")) sp = sonuc.getTag();
        columnChar.add(sp);
        if (sonuc.getRowId() == 0) ilk = true;
        else sb.append(completeChar(deger, sp, sonuc.getCellTip(), false));
      } else if (sonuc.getRowTip() == 3) { // deï¿½erler
        sb.append(
            completeChar(
                deger,
                columnChar.get(sonuc.getColumnId() - 1),
                columnWidth.get(sonuc.getColumnId() - 1),
                false));
      }
    }
    return sb.toString();
  ...
  public static String fromMapToHtmlString(Map s) {
    ...
    for (Object q : s.keySet()) {
      ...
      html.append("<b>")
          .append(q)
          .append("</b>:")
          .append(o != null ? stringToJS(o.toString()) : "");
    }
    return html.toString();
  }
  ...
  */
      ...
      case 2: // Alfa Nï¿½merik
        arr =
            new String[] {
              ...
              "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R", "S", "T", "U", "W", "V", "X",
              "Y", "Z"
            };
        break;
      default:
  ...
  public static String addUniqueValToStr(String source, String add, String delimeter) {
    ...
    if (hasPartInside(source, add)) return source;
    else return source + delimeter + add;
  }
  ...
  public static int getGlobalNextval(
      String seq, String projectUuid, int userId, int customizationId) {
    ...
    if (GenericUtil.isEmpty(vcsUrl))
      throw new IWBException(
          "framework",
          "vcs_url OR vcs_client_key not defined for versioning",
          0,
          "vcs_url not defined for versioning",
          null,
          null);
    String s =
        HttpUtil.send(
            vcsUrl + "/ajaxGlobalNextVal",
    ...
    if (s != null)
      try {
        ...
        if (json.has("errorType") && json.has("error"))
          try {
            throw new IWBException(
                json.getString("errorType"),
                "Global Nextval: remote Error",
                0,
                null,
            ...
            throw new IWBException(
                "framework", "Global Nextval", 0, "JSONException", e.getMessage(), null);
          }
        else
          throw new IWBException(
              "framework", "Global Nextval: remote Error", 0, s, "Unknown Error", null);
      } catch (JSONException e) {
        throw new IWBException(
            "framework", "Global Nextval", 0, "JSONException", e.getMessage(), e.getCause());
      }
    else
      throw new IWBException(
          "framework", "Global Nextval", 0, "JSONException", "No Response from Server", null);
  }

  public static JSONObject fromMapToJSONObject(Map o) throws JSONException {
    JSONObject jo = new JSONObject();
    if (isEmpty(o)) return jo;
    for (Object k : o.keySet()) jo.put(k.toString(), o.get(k));
    return jo;
  }
  ...
  public static NativeArray fromJSONArrayToNativeArray(JSONArray a) throws JSONException {
    ...
    for (int qi = 0; qi < a.length(); qi++) {
      ...
      } else na.putProperty(na, qi, val.toString());
      ;
  ...
  public static NativeObject fromJSONObjectToNativeObject(JSONObject o) throws JSONException {
    ...
    for (Iterator<String> it = o.keys(); it.hasNext(); ) {
      ...
      } else no.put(key, no, val.toString());
    }
    return no;
  }
  ...
  public static String fileAttachPath(int customizationId, String subFolder) {
    String path =
        FrameworkCache.getAppSettingStringValue(customizationId + "", "file_local_path")
            + File.separator
            + customizationId
            + File.separator
            + "attachment";
  ...
  public static String fromMapToURI(Map s) {
    ...
    for (Object q : s.keySet()) {
      ...
      Object o = s.get(q);
      if (o != null) html.append(q).append("=").append(o);
    }
    return html.toString();
  }
